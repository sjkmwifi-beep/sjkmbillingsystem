...
function licensePageHtml() {
  ...
  .fingerprint{font-family:monospace;font-size:11px;color:#8fa0bd;margin-top:6px;word-break:break-all}
  ...
  <body><div class="card">
    ...
    <div class="mid"><span id="mid" style="font-size:12px;word-break:break-all">${mid}</span><button class="ghost" style="margin:0;padding:7px 12px;white-space:nowrap" onclick="copyFull()">Copy</button></div>
    <div class="fingerprint">Fingerprint: ${fp}</div>
...
server.listen(PORT, () => {
  ...
  console.log("============================================");
  console.log(" SJKM DATA LINK Panel");
