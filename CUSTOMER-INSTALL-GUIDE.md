# SJKM NETWORK SERVICE — Setup Guide
...
## Daily use
- Just double-click **`SJKMPanel.bat`** and open **http://localhost:3000**.
...
Make sure Node.js is installed (Step 1) and `SJKMPanel.bat` is in the same folder as the
...
## Need help?
Message me anytime:
- 📱 Phone/SMS: 09383346242
- 💬 Messenger: 
- ✉ Email: sjkmsolutions@gmail.com

— sjkm NETWORK SERVICE
